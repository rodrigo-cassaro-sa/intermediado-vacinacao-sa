...
return [
    ...
    'POST /api/v1/interno/clientes/{id}/unidades/importar' => ['arquivo' => 'interno/acesso.php', 'funcao' => 'rota_importar_unidades'],
    ...
    'PUT  /api/v1/interno/unidades/{id}'            => ['arquivo' => 'interno/acesso.php', 'funcao' => 'rota_editar_unidade'],
