...
```txt
Você vai criar ou revisar notificações, webhooks, filas, retry ou integração externa.
...
protocolos/protocolo-notificacoes-integracoes.md

Evento real:
[EVENTO]

Canal/integração:
[WhatsApp/e-mail/API/webhook/n8n/outro]

Tarefa:
1. Definir evento real.
2. Definir canal e motivo.
3. Definir payload/contrato.
4. Definir consentimento/preferências quando aplicável.
5. Criar registro do evento.
6. Implementar fila/retry se necessário.
7. Implementar idempotência.
8. Registrar logs.
9. Tratar erro.
10. Testar sucesso, falha e duplicidade.
11. Atualizar docs/11 e controle-projeto.md.
```
