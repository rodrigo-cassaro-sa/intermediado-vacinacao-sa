...
```txt
Você vai preparar documentação para outra IA ou programador continuar o projeto.
...
protocolos/protocolo-documentacao-handoff.md

Tarefa:
1. Ler controle-projeto.md.
2. Identificar etapa atual.
3. Identificar decisões tomadas.
4. Identificar arquivos importantes.
5. Identificar pendências.
6. Identificar riscos.
7. Atualizar docs/16-handoff-proxima-ia-programador.md.
8. Atualizar docs/15-changelog-decisoes.md se houver mudança.
9. Atualizar README se necessário.
10. Atualizar controle-projeto.md.

Entrega deve permitir continuação sem perguntar tudo novamente.
```
