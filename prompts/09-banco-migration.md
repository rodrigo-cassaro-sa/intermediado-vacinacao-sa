# Prompt — Banco de Dados e Migration

```txt
Você vai criar ou alterar banco de dados com segurança.
...
protocolos/protocolo-banco-migration.md

Mudança:
[TABELA/CAMPO/ÍNDICE/RELACIONAMENTO]

Ambiente:
[desenvolvimento/homologação/produção]

Tarefa:
1. Entender regra da alteração.
2. Modelar dados.
3. Verificar impacto em backend/API.
4. Verificar LGPD.
5. Criar SQL/migration.
6. Criar rollback.
7. Indicar backup necessário.
8. Testar em ambiente seguro.
9. Atualizar docs/08-modelagem-banco-dados.md.
10. Atualizar docs/15-changelog-decisoes.md.
11. Atualizar controle-projeto.md.

Não alterar produção sem backup e confirmação.
```
