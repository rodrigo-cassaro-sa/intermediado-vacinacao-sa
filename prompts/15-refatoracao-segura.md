...
```txt
Você vai refatorar código preservando comportamento.
...
protocolos/protocolo-refatoracao-segura.md
...
3. Listar arquivos impactados.
4. Criar checklist antes/depois.
5. Refatorar em partes pequenas.
6. Não mudar regra de negócio.
7. Não mudar contrato de API sem autorização.
8. Testar comportamento.
9. Comparar antes/depois.
10. Atualizar documentação e controle-projeto.md.
```
